...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputTwentyTwoPage.dart';  

class AdminSignInTwentyTwoPage extends StatefulWidget {
  @override
  _SignInPage2State createState() => _SignInPage2State();
}

class _SignInPage2State extends State<AdminSignInTwentyTwoPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputTwentyTwoPage()),
      );
    } catch (e) {
