...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputEightPage.dart';  // Import AdminQuizInputOnePage

class AdminSignInEightPage extends StatefulWidget {
  @override
  _SignInPage1State createState() => _SignInPage1State();
}

class _SignInPage1State extends State<AdminSignInEightPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputEightPage()),
      );
    } catch (e) {
