...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputElevenPage.dart';  // Import AdminQuizInputOnePage

class AdminSignInElevenPage extends StatefulWidget {
  @override
  _SignInPage1State createState() => _SignInPage1State();
}

class _SignInPage1State extends State<AdminSignInElevenPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputElevenPage()),
      );
    } catch (e) {
