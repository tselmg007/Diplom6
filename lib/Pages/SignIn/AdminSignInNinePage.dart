...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputNinePage.dart';  // Import AdminQuizInputOnePage

class AdminSignInNinePage extends StatefulWidget {
  @override
  _SignInPage1State createState() => _SignInPage1State();
}

class _SignInPage1State extends State<AdminSignInNinePage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputNinePage()),
      );
    } catch (e) {
