...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputTwelvePage.dart';  

class AdminSignInTwelvePage extends StatefulWidget {
  @override
  _SignInPage2State createState() => _SignInPage2State();
}

class _SignInPage2State extends State<AdminSignInTwelvePage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputTwelvePage()),
      );
    } catch (e) {
