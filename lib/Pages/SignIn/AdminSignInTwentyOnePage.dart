...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputTwentyOnePage.dart';  

class AdminSignInTwentyOnePage extends StatefulWidget {
  @override
  _SignInPage2State createState() => _SignInPage2State();
}

class _SignInPage2State extends State<AdminSignInTwentyOnePage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputTwentyOnePage()),
      );
    } catch (e) {
