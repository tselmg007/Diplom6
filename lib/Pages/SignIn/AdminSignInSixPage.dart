...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputSixPage.dart';  

class AdminSignInSixPage extends StatefulWidget {
  @override
  _SignInPage2State createState() => _SignInPage2State();
}

class _SignInPage2State extends State<AdminSignInSixPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputSixPage()),
      );
    } catch (e) {
