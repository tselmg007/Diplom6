...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputFifteenPage.dart';  // Import AdminQuizInputOnePage

class AdminSignInFifteenPage extends StatefulWidget {
  @override
  _SignInPage1State createState() => _SignInPage1State();
}

class _SignInPage1State extends State<AdminSignInFifteenPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputFifteenPage()),
      );
    } catch (e) {
