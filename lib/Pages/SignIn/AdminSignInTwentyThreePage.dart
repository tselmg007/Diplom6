...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputTwentyThreePage.dart';  

class AdminSignInTwentyThreePage extends StatefulWidget {
  @override
  _SignInPage2State createState() => _SignInPage2State();
}

class _SignInPage2State extends State<AdminSignInTwentyThreePage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputTwentyThreePage()),
      );
    } catch (e) {
