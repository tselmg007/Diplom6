...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputSevenPage.dart';  

class AdminSignInSevenPage extends StatefulWidget {
  @override
  _SignInPage2State createState() => _SignInPage2State();
}

class _SignInPage2State extends State<AdminSignInSevenPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputSevenPage()),
      );
    } catch (e) {
