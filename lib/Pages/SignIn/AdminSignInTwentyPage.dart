...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputTwentyPage.dart';  

class AdminSignInTwentyPage extends StatefulWidget {
  @override
  _SignInPage2State createState() => _SignInPage2State();
}

class _SignInPage2State extends State<AdminSignInTwentyPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputTwentyPage()),
      );
    } catch (e) {
