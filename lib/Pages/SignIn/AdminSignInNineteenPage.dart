...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputNineteenPage.dart';  

class AdminSignInNineteenPage extends StatefulWidget {
  @override
  _SignInPage2State createState() => _SignInPage2State();
}

class _SignInPage2State extends State<AdminSignInNineteenPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputNineteenPage()),
      );
    } catch (e) {
