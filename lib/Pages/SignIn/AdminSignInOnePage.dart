...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputOnePage.dart';  // Import AdminQuizInputOnePage

class AdminSignInOnePage extends StatefulWidget {
  @override
  _SignInPage1State createState() => _SignInPage1State();
}

class _SignInPage1State extends State<AdminSignInOnePage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputOnePage()),
      );
    } catch (e) {
