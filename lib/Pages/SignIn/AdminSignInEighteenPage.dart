...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputEighteenPage.dart';  // Import AdminQuizInputOnePage

class AdminSignInEighteenPage extends StatefulWidget {
  @override
  _SignInPage1State createState() => _SignInPage1State();
}

class _SignInPage1State extends State<AdminSignInEighteenPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputEighteenPage()),
      );
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(  // Add SingleChildScrollView to make the layout scrollable when the keyboard is open
