...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputTwentyFourPage.dart';  

class AdminSignInTwentyFourPage extends StatefulWidget {
  @override
  _SignInPage2State createState() => _SignInPage2State();
}

class _SignInPage2State extends State<AdminSignInTwentyFourPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputTwentyFourPage()),
      );
    } catch (e) {
