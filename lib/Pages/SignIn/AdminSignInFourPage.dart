...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputFourPage.dart';  // Import AdminQuizInputOnePage

class AdminSignInFourPage extends StatefulWidget {
  @override
  _SignInPage1State createState() => _SignInPage1State();
}

class _SignInPage1State extends State<AdminSignInFourPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputFourPage()),
      );
    } catch (e) {
