...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputTwoPage.dart';  // Import AdminQuizInputOnePage

class AdminSignInTwoPage extends StatefulWidget {
  @override
  _SignInPage1State createState() => _SignInPage1State();
}

class _SignInPage1State extends State<AdminSignInTwoPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputTwoPage()),
      );
    } catch (e) {
