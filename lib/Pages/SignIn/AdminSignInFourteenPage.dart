...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputFourteenPage.dart';  // Import AdminQuizInputOnePage

class AdminSignInFourteenPage extends StatefulWidget {
  @override
  _SignInPage1State createState() => _SignInPage1State();
}

class _SignInPage1State extends State<AdminSignInFourteenPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputFourteenPage()),
      );
    } catch (e) {
