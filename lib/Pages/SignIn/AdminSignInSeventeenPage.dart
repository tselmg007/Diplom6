...
import 'package:traffic/Pages/AdminQuestionInput/AdminQuizInputSeventeenPage.dart';  

class AdminSignInSeventeenPage extends StatefulWidget {
  @override
  _SignInPage2State createState() => _SignInPage2State();
}

class _SignInPage2State extends State<AdminSignInSeventeenPage> {
  ...
  Future<void> signInWithEmailPassword(String email, String password) async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => AdminQuizInputSeventeenPage()),
      );
    } catch (e) {
