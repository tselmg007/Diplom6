...
class UserExerciseSeventeen extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseSeventeen({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseSeventeen> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseSeventeen> {
