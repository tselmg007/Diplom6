...
class UserExerciseThree extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseThree({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseThree> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseThree> {
