...
class UserExerciseEleven extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseEleven({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseEleven> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseEleven> {
