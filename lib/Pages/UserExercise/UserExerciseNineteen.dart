...
class UserExerciseNineteen extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseNineteen({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseNineteen> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseNineteen> {
