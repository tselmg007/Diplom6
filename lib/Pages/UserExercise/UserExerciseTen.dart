...
class UserExerciseTen extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseTen({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseTen> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseTen> {
