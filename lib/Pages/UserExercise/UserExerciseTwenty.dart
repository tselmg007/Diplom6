...
class UserExerciseTwenty extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseTwenty({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseTwenty> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseTwenty> {
