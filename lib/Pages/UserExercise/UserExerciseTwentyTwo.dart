...
class UserExerciseTwentyTwo extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseTwentyTwo({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseTwentyTwo> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseTwentyTwo> {
