...
class UserExerciseSeven extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseSeven({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseSeven> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseSeven> {
