...
class UserExerciseTwentyFour extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseTwentyFour({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseTwentyFour> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseTwentyFour> {
