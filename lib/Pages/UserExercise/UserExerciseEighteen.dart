...
class UserExerciseEighteen extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseEighteen({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseEighteen> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseEighteen> {
