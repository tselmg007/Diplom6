...
class UserExerciseOne extends StatefulWidget {
  ...
  const UserExerciseOne({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseOne> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseOne> {
