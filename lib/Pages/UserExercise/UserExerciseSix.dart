...
class UserExerciseSix extends StatefulWidget {
  final int startIndex;
  final int endIndex;

  const UserExerciseSix({Key? key, required this.startIndex, required this.endIndex}) : super(key: key);

  @override
  State<UserExerciseSix> createState() => _UserExerciseState();
}

class _UserExerciseState extends State<UserExerciseSix> {
