...
class AdminQuizTwentyFourListPage extends StatefulWidget {
  const AdminQuizTwentyFourListPage({Key? key}) : super(key: key);

  @override
  State<AdminQuizTwentyFourListPage> createState() => _AdminQuizListOnePagesState();
}

class _AdminQuizListOnePagesState extends State<AdminQuizTwentyFourListPage> {
