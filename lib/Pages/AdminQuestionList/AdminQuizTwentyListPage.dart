...
class AdminQuizTwentyListPage extends StatefulWidget {
  const AdminQuizTwentyListPage({Key? key}) : super(key: key);

  @override
  State<AdminQuizTwentyListPage> createState() => _AdminQuizListOnePagesState();
}

class _AdminQuizListOnePagesState extends State<AdminQuizTwentyListPage> {
