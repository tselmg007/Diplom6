...
class AdminQuizSevenListPage extends StatefulWidget {
  const AdminQuizSevenListPage({Key? key}) : super(key: key);

  @override
  State<AdminQuizSevenListPage> createState() => _AdminQuizListOnePagesState();
}

class _AdminQuizListOnePagesState extends State<AdminQuizSevenListPage> {
