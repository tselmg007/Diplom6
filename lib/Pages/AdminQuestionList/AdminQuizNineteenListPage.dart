...
class AdminQuizNineteenListPage extends StatefulWidget {
  const AdminQuizNineteenListPage({Key? key}) : super(key: key);

  @override
  State<AdminQuizNineteenListPage> createState() => _AdminQuizListOnePagesState();
}

class _AdminQuizListOnePagesState extends State<AdminQuizNineteenListPage> {
