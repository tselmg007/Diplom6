...
class AdminQuizThirteenListPage extends StatefulWidget {
  const AdminQuizThirteenListPage({Key? key}) : super(key: key);

  @override
  State<AdminQuizThirteenListPage> createState() =>
      _AdminQuizListOnePagesState();
}

class _AdminQuizListOnePagesState extends State<AdminQuizThirteenListPage> {
