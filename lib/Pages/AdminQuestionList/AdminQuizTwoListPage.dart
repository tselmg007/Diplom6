...
class AdminQuizTwoListPage extends StatefulWidget {
  const AdminQuizTwoListPage({Key? key}) : super(key: key);

  @override
  State<AdminQuizTwoListPage> createState() => _AdminQuizTwoListPageState();
}

class _AdminQuizTwoListPageState extends State<AdminQuizTwoListPage> {
  ...
  Future<void> deleteQuestion(String id) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("⚠️ Алдаа гарлаа. Асуулт устгах боломжгүй!"),
      ...
      body: StreamBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return Center(child: Text("⚠️ Алдаа гарлаа: ${snapshot.error}"));
          }

          final questions = snapshot.data ?? [];

          if (questions.isEmpty) {
            return Center(child: Text("📝 Одоогоор асуулт байхгүй байна."));
          }
