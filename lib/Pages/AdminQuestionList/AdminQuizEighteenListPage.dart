...
class AdminQuizEighteenListPage extends StatefulWidget {
  const AdminQuizEighteenListPage({Key? key}) : super(key: key);

  @override
  State<AdminQuizEighteenListPage> createState() => _AdminQuizListOnePagesState();
}

class _AdminQuizListOnePagesState extends State<AdminQuizEighteenListPage> {
      ...
      body: StreamBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return Center(child: Text("Асуулт бүртгэгдээгүй байна."));
          }
