...
class AdminQuizSeventeenListPage extends StatefulWidget {
  const AdminQuizSeventeenListPage({Key? key}) : super(key: key);

  @override
  State<AdminQuizSeventeenListPage> createState() => _AdminQuizListOnePagesState();
}

class _AdminQuizListOnePagesState extends State<AdminQuizSeventeenListPage> {
