...
class AdminQuizTenListPage extends StatefulWidget {
  const AdminQuizTenListPage({Key? key}) : super(key: key);

  @override
  State<AdminQuizTenListPage> createState() => _AdminQuizListOnePagesState();
}

class _AdminQuizListOnePagesState extends State<AdminQuizTenListPage> {
