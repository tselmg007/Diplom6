...
class WrongAnswerDetailPageNineteen extends StatefulWidget {
  const WrongAnswerDetailPageNineteen({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageNineteen> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageNineteen> {
  ...
  static const String collectionName = 'WrongAnswerTestNineteenCollection';
