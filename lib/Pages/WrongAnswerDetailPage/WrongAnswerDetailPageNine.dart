...
class WrongAnswerDetailPageNine extends StatefulWidget {
  const WrongAnswerDetailPageNine({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageNine> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageNine> {
  ...
  static const String collectionName = 'WrongAnswerTestNineCollection';
