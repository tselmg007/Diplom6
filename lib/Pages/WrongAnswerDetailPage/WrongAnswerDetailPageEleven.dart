...
class WrongAnswerDetailPageEleven extends StatefulWidget {
  const WrongAnswerDetailPageEleven({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageEleven> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageEleven> {
  ...
  static const String collectionName = 'WrongAnswerTestElevenCollection';
