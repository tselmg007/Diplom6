...
class WrongAnswerDetailPageTwelve extends StatefulWidget {
  const WrongAnswerDetailPageTwelve({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageTwelve> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageTwelve> {
  ...
  static const String collectionName = 'WrongAnswerTestTwelveCollection';
