...
class WrongAnswerDetailPageFourteen extends StatefulWidget {
  const WrongAnswerDetailPageFourteen({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageFourteen> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageFourteen> {
  ...
  static const String collectionName = 'WrongAnswerTestFourteenCollection';
