...
class WrongAnswerDetailPageSix extends StatefulWidget {
  const WrongAnswerDetailPageSix({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageSix> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageSix> {
  ...
  static const String collectionName = 'WrongAnswerTestSixCollection';
