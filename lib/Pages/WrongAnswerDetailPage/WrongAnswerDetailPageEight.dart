...
class WrongAnswerDetailPageEight extends StatefulWidget {
  const WrongAnswerDetailPageEight({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageEight> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageEight> {
  ...
  static const String collectionName = 'WrongAnswerTestEightCollection';
