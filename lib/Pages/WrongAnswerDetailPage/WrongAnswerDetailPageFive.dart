...
class WrongAnswerDetailPageFive extends StatefulWidget {
  const WrongAnswerDetailPageFive({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageFive> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageFive> {
  ...
  static const String collectionName = 'WrongAnswerTestFiveCollection';
