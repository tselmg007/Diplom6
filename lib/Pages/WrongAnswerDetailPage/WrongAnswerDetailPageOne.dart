...
class WrongAnswerDetailPageOne extends StatefulWidget {
  const WrongAnswerDetailPageOne({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageOne> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageOne> {
  ...
  static const String collectionName = 'WrongAnswerTestCollection';
