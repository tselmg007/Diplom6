...
class WrongAnswerDetailPageTwenty extends StatefulWidget {
  const WrongAnswerDetailPageTwenty({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageTwenty> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageTwenty> {
  ...
  static const String collectionName = 'WrongAnswerTestTwentyCollection';
