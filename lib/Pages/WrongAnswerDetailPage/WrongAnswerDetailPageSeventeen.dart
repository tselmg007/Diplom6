...
class WrongAnswerDetailPageSeventeen extends StatefulWidget {
  const WrongAnswerDetailPageSeventeen({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageSeventeen> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageSeventeen> {
  ...
  static const String collectionName = 'WrongAnswerTestSeventeenCollection';
