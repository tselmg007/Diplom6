...
class WrongAnswerDetailPageThree extends StatefulWidget {
  const WrongAnswerDetailPageThree({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageThree> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageThree> {
  ...
  static const String collectionName = 'WrongAnswerTestThreeCollection';
