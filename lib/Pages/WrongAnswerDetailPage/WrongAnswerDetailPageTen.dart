...
class WrongAnswerDetailPageTen extends StatefulWidget {
  const WrongAnswerDetailPageTen({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageTen> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageTen> {
  ...
  static const String collectionName = 'WrongAnswerTestTenCollection';
