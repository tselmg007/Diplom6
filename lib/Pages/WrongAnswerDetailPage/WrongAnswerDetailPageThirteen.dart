...
class WrongAnswerDetailPageThirteen extends StatefulWidget {
  const WrongAnswerDetailPageThirteen({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageThirteen> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageThirteen> {
  ...
  static const String collectionName = 'WrongAnswerTestThirteenCollection';
