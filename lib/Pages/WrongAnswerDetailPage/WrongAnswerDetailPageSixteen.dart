...
class WrongAnswerDetailPageSixteen extends StatefulWidget {
  const WrongAnswerDetailPageSixteen({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageSixteen> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageSixteen> {
  ...
  static const String collectionName = 'WrongAnswerTestSixteenCollection';
