...
class WrongAnswerDetailPageEighteen extends StatefulWidget {
  const WrongAnswerDetailPageEighteen({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageEighteen> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageEighteen> {
  ...
  static const String collectionName = 'WrongAnswerTestEighteenCollection';
