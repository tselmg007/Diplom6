...
class WrongAnswerDetailPageTwo extends StatefulWidget {
  const WrongAnswerDetailPageTwo({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageTwo> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageTwo> {
  ...
  static const String collectionName = 'WrongAnswerTestTwoCollection';
