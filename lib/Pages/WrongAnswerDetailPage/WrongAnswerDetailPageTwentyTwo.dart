...
class WrongAnswerDetailPageTwentyTwo extends StatefulWidget {
  const WrongAnswerDetailPageTwentyTwo({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageTwentyTwo> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageTwentyTwo> {
  ...
  static const String collectionName = 'WrongAnswerTestTwentyTwoCollection';
