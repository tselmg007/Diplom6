...
class WrongAnswerDetailPageTwentyOne extends StatefulWidget {
  const WrongAnswerDetailPageTwentyOne({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageTwentyOne> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageTwentyOne> {
  ...
  static const String collectionName = 'WrongAnswerTestTwentyOneCollection';
