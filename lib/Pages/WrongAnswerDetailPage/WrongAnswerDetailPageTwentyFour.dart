...
class WrongAnswerDetailPageTwentyFour extends StatefulWidget {
  const WrongAnswerDetailPageTwentyFour({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageTwentyFour> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageTwentyFour> {
  ...
  static const String collectionName = 'WrongAnswerTestTwentyFourCollection';
