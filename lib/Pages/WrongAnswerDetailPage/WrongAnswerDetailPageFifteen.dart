...
class WrongAnswerDetailPageFifteen extends StatefulWidget {
  const WrongAnswerDetailPageFifteen({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageFifteen> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageFifteen> {
  ...
  static const String collectionName = 'WrongAnswerTestFifteenCollection';
