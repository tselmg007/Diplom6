...
class WrongAnswerDetailPageTwentyThree extends StatefulWidget {
  const WrongAnswerDetailPageTwentyThree({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageTwentyThree> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageTwentyThree> {
  ...
  static const String collectionName = 'WrongAnswerTestTwentyThreeCollection';
