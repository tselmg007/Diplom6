...
class WrongAnswerDetailPageFour extends StatefulWidget {
  const WrongAnswerDetailPageFour({Key? key}) : super(key: key);

  @override
  State<WrongAnswerDetailPageFour> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<WrongAnswerDetailPageFour> {
  ...
  static const String collectionName = 'WrongAnswerTestFourCollection';
