...
class RedFlashCard extends StatefulWidget {
  const RedFlashCard({Key? key}) : super(key: key);

  @override
  State<RedFlashCard> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<RedFlashCard> {
  ...
  static const String collectionName = 'RedFlashCardCollection';
