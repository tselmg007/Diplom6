...
class ComplicatedQuestion extends StatefulWidget {
  const ComplicatedQuestion({Key? key}) : super(key: key);

  @override
  State<ComplicatedQuestion> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<ComplicatedQuestion> {
  ...
  static const String collectionName = 'ComplicatedQuestionCollection';
