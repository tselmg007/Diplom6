...
class SkipQuizPage extends StatefulWidget {
  const SkipQuizPage({Key? key}) : super(key: key);

  @override
  State<SkipQuizPage> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<SkipQuizPage> {
  ...
  static const String collectionName = 'SkipQuizCollection';
