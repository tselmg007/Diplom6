...
class YellowFlashCard extends StatefulWidget {
  const YellowFlashCard({Key? key}) : super(key: key);

  @override
  State<YellowFlashCard> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<YellowFlashCard> {
  ...
  static const String collectionName = 'YellowFlashCardCollection';
