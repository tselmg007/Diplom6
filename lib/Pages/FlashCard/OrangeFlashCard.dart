...
class OrangeFlashCard extends StatefulWidget {
  const OrangeFlashCard({Key? key}) : super(key: key);

  @override
  State<OrangeFlashCard> createState() => _WrongAnswerDetailPage1State();
}

class _WrongAnswerDetailPage1State extends State<OrangeFlashCard> {
  ...
  static const String collectionName = 'OrangeFlashCardCollection';
