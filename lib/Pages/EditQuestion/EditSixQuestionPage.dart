...
class EditSixQuestionPage extends StatefulWidget {
...
class _EditOneQuestionPageState extends State<EditSixQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz6_images/$fileName');
