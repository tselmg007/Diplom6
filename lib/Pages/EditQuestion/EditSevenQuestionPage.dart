...
class EditSevenQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditSevenQuestionPage({
...
class _EditOneQuestionPageState extends State<EditSevenQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz7_images/$fileName');
