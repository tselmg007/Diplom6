...
class EdiFiveQuestionPage extends StatefulWidget {
...
class _EditOneQuestionPageState extends State<EdiFiveQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz5_images/$fileName');
  ...
  Future<void> updateQuestion() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
          .collection('SmartTrafficInputCollection')
