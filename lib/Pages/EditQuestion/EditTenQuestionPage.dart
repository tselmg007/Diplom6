...
class EditTenQuestionPage extends StatefulWidget {
...
class _EditOneQuestionPageState extends State<EditTenQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz10_images/$fileName');
