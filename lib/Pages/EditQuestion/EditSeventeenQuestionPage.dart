...
class EditSeventeenQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditSeventeenQuestionPage({
...
class _EditOneQuestionPageState extends State<EditSeventeenQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz17_$questionId.png';
      final ref = FirebaseStorage.instance.ref().child('quiz17_images/$fileName');
