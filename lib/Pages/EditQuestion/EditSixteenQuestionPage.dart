...
class EditSixteenQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditSixteenQuestionPage({
...
class _EditOneQuestionPageState extends State<EditSixteenQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz16_$questionId.png';
      final ref = FirebaseStorage.instance.ref().child('quiz16_images/$fileName');
  ...
  Future<void> updateQuestion() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
          .collection('SmartTrafficSixteenCollection')
