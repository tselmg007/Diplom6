...
class EditTwelveQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditTwelveQuestionPage({
...
class _EditOneQuestionPageState extends State<EditTwelveQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz12_images/$fileName');
