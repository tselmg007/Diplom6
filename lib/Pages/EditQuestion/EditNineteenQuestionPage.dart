...
class EditNineteenQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditNineteenQuestionPage({
...
class _EditOneQuestionPageState extends State<EditNineteenQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz19_images/$fileName');
