...
class EditTwentyTwoQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditTwentyTwoQuestionPage({
...
class _EditOneQuestionPageState extends State<EditTwentyTwoQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz22_images/$fileName');
