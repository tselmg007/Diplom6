...
class EditThreeQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditThreeQuestionPage({
...
class _EditOneQuestionPageState extends State<EditThreeQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz3_images/$fileName');
