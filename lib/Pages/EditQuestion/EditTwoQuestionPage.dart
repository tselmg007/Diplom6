...
class EditTwoQuestionPage extends StatefulWidget {
...
class _EditOneQuestionPageState extends State<EditTwoQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz2_images/$fileName');
