...
class EditTwentyOneQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditTwentyOneQuestionPage({
...
class _EditOneQuestionPageState extends State<EditTwentyOneQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz21_images/$fileName');
