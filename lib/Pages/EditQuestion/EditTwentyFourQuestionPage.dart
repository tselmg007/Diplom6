...
class EditTwentyFourQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditTwentyFourQuestionPage({
...
class _EditOneQuestionPageState extends State<EditTwentyFourQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz24_images/$fileName');
