...
class EditEighteenQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditEighteenQuestionPage({
...
class _EditOneQuestionPageState extends State<EditEighteenQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz18_images/$fileName');
