...
class EditThirteenQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditThirteenQuestionPage({
...
class _EditOneQuestionPageState extends State<EditThirteenQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz13_images/$fileName');
