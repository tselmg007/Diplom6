...
class EditFourteenQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditFourteenQuestionPage({
...
class _EditOneQuestionPageState extends State<EditFourteenQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz14_$questionId.png';
      final ref = FirebaseStorage.instance.ref().child('quiz14_images/$fileName');
  ...
  Future<void> updateQuestion() async {
    ...
    try {
      ...
      await FirebaseFirestore.instance
          .collection('SmartTrafficFourteenCollection')
