...
class EditTwentyThreeQuestionPage extends StatefulWidget {
  final String questionId;
  final Map<String, dynamic> questionData;

  EditTwentyThreeQuestionPage({
...
class _EditOneQuestionPageState extends State<EditTwentyThreeQuestionPage> {
  ...
  Future<String?> _uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      ...
      final ref = FirebaseStorage.instance.ref().child('quiz23_images/$fileName');
