...
class AdminQuizInputSevenPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputSevenPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputSevenCollection';
  static const String storagePath = 'quiz7_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz7_$questionId.png';
