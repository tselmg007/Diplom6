...
class AdminQuizInputTwentyTwoPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputTwentyTwoPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputTwentyTwoCollection';
  static const String storagePath = 'quiz22_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz22_$questionId.png';
