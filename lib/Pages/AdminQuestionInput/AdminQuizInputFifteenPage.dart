...
class AdminQuizInputFifteenPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputFifteenPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputFifteenCollection';
  static const String storagePath = 'quiz15_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz15_$questionId.png';
