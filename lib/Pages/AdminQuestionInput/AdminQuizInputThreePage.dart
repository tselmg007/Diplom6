...
class AdminQuizInputThreePage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputThreePage> {
  ...
  static const String quizCollection = 'SmartTrafficInputThreeCollection';
  static const String storagePath = 'quiz3_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz3_$questionId.png';
