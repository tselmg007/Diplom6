...
class AdminQuizInputEighteenPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputEighteenPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputEighteenCollection';
  static const String storagePath = 'quiz18_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz18_$questionId.png';
