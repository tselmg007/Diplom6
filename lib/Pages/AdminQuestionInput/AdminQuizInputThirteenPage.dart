...
class AdminQuizInputThirteenPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputThirteenPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputThirteenCollection';
  static const String storagePath = 'quiz13_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz13_$questionId.png';
