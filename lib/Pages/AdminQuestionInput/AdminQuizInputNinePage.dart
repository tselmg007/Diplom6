...
class AdminQuizInputNinePage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputNinePage> {
  ...
  static const String quizCollection = 'SmartTrafficInputNineCollection';
  static const String storagePath = 'quiz9_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz9_$questionId.png';
