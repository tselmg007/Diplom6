...
class AdminQuizInputTwentyOnePage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputTwentyOnePage> {
  ...
  static const String quizCollection = 'SmartTrafficInputTwentyOneCollection';
  static const String storagePath = 'quiz21_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz21_$questionId.png';
