...
class AdminQuizInputEightPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputEightPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputEightCollection';
  static const String storagePath = 'quiz8_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz8_$questionId.png';
