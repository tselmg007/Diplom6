...
class AdminQuizInputSixPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputSixPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputSixCollection';
  static const String storagePath = 'quiz6_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz6_$questionId.png';
