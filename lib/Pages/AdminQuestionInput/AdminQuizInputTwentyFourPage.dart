...
class AdminQuizInputTwentyFourPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputTwentyFourPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputTwentyFourCollection';
  static const String storagePath = 'quiz24_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz24_$questionId.png';
