...
class AdminQuizInputTenPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputTenPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputTenCollection';
  static const String storagePath = 'quiz10_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz10_$questionId.png';
