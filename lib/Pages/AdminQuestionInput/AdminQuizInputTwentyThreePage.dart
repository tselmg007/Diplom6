...
class AdminQuizInputTwentyThreePage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputTwentyThreePage> {
  ...
  static const String quizCollection = 'SmartTrafficInputTwentyThreeCollection';
  static const String storagePath = 'quiz23_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz23_$questionId.png';
