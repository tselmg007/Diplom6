...
class AdminQuizInputSeventeenPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputSeventeenPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputSeventeenCollection';
  static const String storagePath = 'quiz11_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz11_$questionId.png';
