...
class AdminQuizInputFourPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputFourPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputFourCollection';
  static const String storagePath = 'quiz4_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz4_$questionId.png';
