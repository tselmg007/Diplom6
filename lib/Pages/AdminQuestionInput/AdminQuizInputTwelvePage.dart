...
class AdminQuizInputTwelvePage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputTwelvePage> {
  ...
  static const String quizCollection = 'SmartTrafficInputTwelveCollection';
  static const String storagePath = 'quiz12_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz12_$questionId.png';
