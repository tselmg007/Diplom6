...
class AdminQuizInputTwoPage extends StatefulWidget {
  @override
  _AdminQuizInputOnePageState createState() => _AdminQuizInputOnePageState();
}

class _AdminQuizInputOnePageState extends State<AdminQuizInputTwoPage> {
  ...
  static const String quizCollection = 'SmartTrafficInputTwoCollection';
  static const String storagePath = 'quiz2_images/';

  Future<String?> uploadImage(Uint8List imageBytes, String questionId) async {
    try {
      final fileName = 'quiz2_$questionId.png';
